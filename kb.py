...
exit_kb = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Выход в меню")]], resize_keyboard=True)
iexeit_kb = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="Выход в меню", callback_data="menu")]])


# second variant to create buttons
